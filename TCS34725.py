...
class TCS34725:
    ...
    **Quickstart: Importing and using the device**
    ...
    def __init__(self, i2c: I2C, address: int = 0x29):
        ...
        self.setIntegration_time(24)
        self.glass_attenuation = 1.0

        self._write_u8(_REGISTER_CONFIG | _COMMAND_BIT, 0)
    ...
    def color_rgb_bytes(self):
        ...
        clear = int(math.sqrt(r * r + g * g + b * b))

        red = int(r / clear * 255)
        green = int(g / clear * 255)
        blue = int(b / clear * 255)
    ...
    def setActive(self, val: bool):
        ...
        if val:
            ...
            self._write_u8(_REGISTER_ENABLE, enable & ~(_ENABLE_AEN))
    ...
    def getIntegration_time(self):
        """The integration time of the sensor in milliseconds."""
        return self._integration_time

    def setIntegration_time(self, val: float):
        if (
    ...
    def clearInterrupt(self, val: bool):
        if val:
            raise ValueError(
                "Interrupt should be set to False in order to clear the interrupt"
            )

        self._bus.writeto(self._i2c_address, b'\xe6')
